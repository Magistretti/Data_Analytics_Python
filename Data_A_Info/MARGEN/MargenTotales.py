...
'''	
  ...
  '''      ,db_conex)
controlVtasX = controlVtasX.convert_dtypes()


###### Informacion Sobre Ventas, costos y Margenes Acumuladas

controlVtasMX = pd.read_sql(   
'''	
	...
	group by p.AGRUPACION
  '''      ,db_conex)
controlVtasMX = controlVtasMX.convert_dtypes()
controlVtasX = controlVtasX.merge(controlVtasMX, on='AGRUPACION', how='outer')
########## Informacion sobre ventas y Margenes Diario
...
controlVtas = controlVtas.merge(controlVtasX, on=['AGRUPACION','Ventas Diarias'
        ,'Ventas Acumuladas'
        ,'Costo Diario'
        ,'Costo Acumulado'
        ,'Margen Diario'
...
controlVtas = _estiladorVtaTituloD(controlVtas,numCols,percColsPen, "MARGENES TOTALES")

ubicacion = "C:/Informes/MARGEN/"
nombreGNC = "Info_Presupuesto_GNC.png"
nombreGNCproy = "MARGENESTOTALES.png"
