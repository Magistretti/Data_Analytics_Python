...
df_gasoleosTotal = pd.read_sql(f'''
    ...
    WHERE FECHASQL >= '{primer_dia_mes_anterior.strftime("%Y-%d-%m")}'
...
precioCartelypf=df_gasoleosTotal
precioCartelypf_GO=precioCartelypf.loc[precioCartelypf["CODPRODUCTO"] == 'GO   ',:]
precioCartelypf_EU=precioCartelypf.loc[precioCartelypf["CODPRODUCTO"] == 'EU   ',:]

precioCartelypf_GO=precioCartelypf_GO['Precio Cartel'].max()
precioCartelypf_EU=precioCartelypf_EU['Precio Cartel'].max()
...
precioCartelDapsa=df_gasoleosdapsa
precioCartelDapsa_GO=precioCartelDapsa.loc[precioCartelDapsa["CODPRODUCTO"] == 'GO   ',:]
precioCartelDapsa_EU=precioCartelDapsa.loc[precioCartelDapsa["CODPRODUCTO"] == 'EU   ',:]

precioCartelDapsa_GO=precioCartelDapsa_GO['Precio Cartel'].max()
precioCartelDapsa_EU=precioCartelDapsa_EU['Precio Cartel'].max()
...
first_day_last_month = primer_dia_mes_anterior.strftime("%Y-%m-%d")
last_day_last_month = ultimo_dia_mes_anterior.strftime("%Y-%m-%d")
