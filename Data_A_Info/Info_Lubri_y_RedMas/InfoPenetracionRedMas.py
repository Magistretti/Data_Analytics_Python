...
def penetracion_liq(conexMSSQL):
    ...
    df_penetRM_liq_x_turno.loc['colTOTAL', 'Objetivo']=total 
...
def penetracion_GNC(conexMSSQL):
    ...
    df_presupuesto_gnc['Objetivo']=df_presupuesto_gnc['CANT OP RM']/df_presupuesto_gnc['Presupuesto Mensual REDMAS']
    ...
    df_penetRM_GNC_x_turno.loc['colTOTAL', 'Objetivo']=total
