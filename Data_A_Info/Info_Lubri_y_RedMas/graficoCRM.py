...
def clasificador(df):
    ...
    for i in range(len(ultimos_30_dias)):
        ...
        dfTOTAL.loc[i,'Clientes Activos']= activos-recaptadas
...
clientespordia=clientespordia.reindex(columns={'Fecha','Clientes Pasivos','Clientes Activos','Nuevos Clientes','Clientes Recaptados'})
...
plt.savefig("C:/Informes/InfoLubri_y_RedMas/grafico.png")
