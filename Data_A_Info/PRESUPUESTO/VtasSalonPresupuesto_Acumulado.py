...
Total = pd.concat([egncA,egncP2,egncPO,egncL,egncSJ,egncP1,egncM1])
...
presusalon=presusalon.reindex(columns=['UEN', 'CODPRODUCTO', 'Venta diaria', 'Presupuesto Acumulado',  'ID_x', 'TOTAL VENDIDO_x', 'ID_y', 'TOTAL VENDIDO_y'])
...
presusalon=presusalon.drop('Presupuesto Diario', axis='columns')
presusalon=presusalon.drop('Ventas Diario', axis='columns')
presusalon=presusalon.drop('Desvio Diario', axis='columns')
presusalon=presusalon.drop('Porcentual Diario', axis='columns')
presusalon=presusalon.rename({'Porcentual Acumulado':'Desvio %'},axis=1)
...
numCols0 = ["Presupuesto Acumulado"
        ,"Ventas Acumulado"
        ,"Desvio Acumulado"
...
nombreGNCproy = "PresupuestadoSalon_Acumulado.png"
